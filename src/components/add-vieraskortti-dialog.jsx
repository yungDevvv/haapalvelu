...
export function AddVieraskorttiDialog({ open, onOpenChange, onSave }) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Lisää uusi vieraskortti</DialogTitle>
          <DialogDescription>
            Luo uusi vieraskortti. Lisää korttiin yksi tai useampi vieras.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="title">Kortin nimi *</Label>
            <Input
              id="title"
              {...register("title")}
              placeholder="Esim. Morsiamen vanhemmat, Liisan perhe..."
            />
            {errors.title && (
          ...
          <div className="space-y-2">
            <Label htmlFor="category">Ryhmä *</Label>
          ...
          <div className="border-t pt-4 space-y-2">
            <h4 className="font-medium text-sm">Yhteystiedot (yhteinen kortille)</h4>
            <div className="space-y-2">
              <Input
          ...
          {/* Guests in card */}
          <div className="border-t pt-4 space-y-2">
            <h4 className="font-medium text-sm">Vieraat kortilla ({guestsInCard.length})</h4>
