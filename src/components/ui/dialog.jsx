...
const DialogOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed grid overflow-auto place-items-center inset-0 z-50 bg-black/80",
      className
    )}
    {...props} />
))
  ...
  <DialogPortal>
    <DialogOverlay>
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "z-50 w-full max-w-2xl p-6 bg-white rounded-lg shadow-lg transition-transform transform",
          className
        )}
        {...props}>
        {children}
